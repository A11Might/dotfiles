...
# General {
	...
	# The theme to use.
	export TMUX_POWERLINE_THEME="kohath"
	# Overlay directory to look for themes. There you can put your own themes outside the repo. Fallback will still be the "themes" directory in the repo.
	export TMUX_POWERLINE_DIR_USER_THEMES="${XDG_CONFIG_HOME:-$HOME/.config}/tmux-powerline"
...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/p0/kb961x5d6wd79gfp2h6t_8500000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
